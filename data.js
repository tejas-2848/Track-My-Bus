...
const SMART_ST_DATA = {
  ...
  busStops: [
    {
      ...
      facilities: [
        ...
        { name: "Public Toilet", nameMr: "सार्वजनिक शौचालय", icon: "🚻", status: "150m distance" },
        { name: "Tea & Canteen", nameMr: "एस.टी. कँटीन व फराळ", icon: "🏪", status: "Inside Stand" }
      ],
      emergencyContacts: [
        { role: "MSRTC Niphad Depot Control", number: "02550-241223", icon: "📞" },
        { role: "Niphad Police Station", number: "02550-241033", icon: "🚓" },
        { role: "Sub-District Hospital Niphad", number: "02550-241045", icon: "🏥" },
        { role: "Station Master Niphad", number: "+91 94227 65110", icon: "👤" }
      ]
    },
    {
      id: "SNR-02",
  ...
  buses: [
    {
      ...
      fuel: "78% (Diesel)",
      distanceFromStop: 3.2, // km
      etaMinutes: 5,
      previousStop: "Chandori Stand",
      ...
      intermediateStops: [
        ...
        { name: "Dwarka Circle", time: "10:45 AM", status: "Departed", delay: "0 min", lat: 19.9880, lng: 73.8050 },
        { name: "Chandori Stand", time: "11:15 AM", status: "Departed", delay: "0 min", lat: 20.0385, lng: 73.9850 },
        { name: "Niphad Bus Stand", time: "11:42 AM", status: "NEXT STOP", delay: "On Time", isCurrentTarget: true, lat: 20.0825, lng: 74.1080 },
        { name: "Vinchur Stand", time: "12:10 PM", status: "Scheduled", delay: "0 min", lat: 20.1185, lng: 74.2380 },
        { name: "Kotamgaon Phata", time: "12:35 PM", status: "Scheduled", delay: "0 min", lat: 20.0850, lng: 74.3650 },
        { name: "Yeola Bus Stand", time: "01:00 PM", status: "Scheduled", delay: "0 min", lat: 20.0425, lng: 74.4890 }
      ]
    },
    {
      id: "BUS-102",
  ...
  schedules: [
    ...
    { time: "11:42 AM", busNumber: "MH 15 EG 4021", destination: "Yeola Bus Stand", type: "Ordinary", status: "Live", isLive: true },
    ...
    { time: "01:15 PM", busNumber: "MH 15 BJ 7712", destination: "Yeola Paithani City", type: "Shivshahi", status: "Scheduled" },
